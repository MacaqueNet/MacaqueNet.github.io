...
<ul class="actions" style="display: flex; list-style: none; padding: 0; gap: 10px;">
    ...
    <li style="margin: 0;"><a href="https://github.com/MacaqueNet/MacaqueNet.github.io/blob/main/database_version_TEMP.md" frameborder="no" width="100%" height="100%" target="_blank" class="button big">Database Version</a></li>
</ul>
